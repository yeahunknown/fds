...
const TransactionList = ({ transactions }: TransactionListProps) => {
  ...
  const handleCopy = async (txId: string, e: React.MouseEvent) => {
    e.stopPropagation();
    const txHashes = [
      '2NbQ1mZuBEqzBfVdWJxCWkbo6ScVR5ALrgMDnMfs9KyMXC7Q7E1JWRCvTC6wZ8hHUbL7PaHsO8VnmGh2XNwC81Be',
      '8FaY2DqNH86xqSHZ3X6vTgNqMfYrpVjRYiFeaJCTH3xrbABxTmg6BrRMCa4rFhwMZfdfZuWVP9ABLnaOpo3tVNX81'
    ];
